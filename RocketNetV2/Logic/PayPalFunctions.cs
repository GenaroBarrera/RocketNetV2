...
public class NVPAPICaller
{
  ...
  public bool ShortcutExpressCheckout(string amt, ref string token, ref string retMsg)
  {
    ...
    using (RocketNetV2.Logic.ShoppingCartActions myCartOrders = new RocketNetV2.Logic.ShoppingCartActions())
    {
  ...
  public string HttpCall(string NvpRequest)
  {
    ...
    {
      // Log the exception.
      RocketNetV2.Logic.ExceptionUtility.LogException(e, "HttpCall in PayPalFunction.cs");
    }
